...
$Properties = @{
Property = "*",
@{label = 'Principal'; expression = {[string]::Format("@{{DisplayName={0}, GroupId={1}, Id={2}, LogonType={3}, RunLevel={4}, UserId={5}, ProcessTokenSidType={6}, RequiredPrivilege={7}}}", $_.Principal.DisplayName, $_.Principal.GroupId, $_.Principal.Id, $_.Principal.LogonType, $_.Principal.RunLevel, $_.Principal.UserId, $_.Principal.ProcessTokenSidType, $_.Principal.RequiredPrivilege)}},
